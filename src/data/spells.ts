...
export const spells: SpellType[] = [
  ...
  },
  {
    ...
    description: [
      ...
      "Quando você inscreve o glifo, escolha runas explosivasou glifo de magia.",
  ...
  },
  {
    ...
    description: [
      ...
      "A muralha é um objeto que pode ser danificado e então, partido. Ela tem CA 12, 30 pontos de vida por seção de 3 metros e é vulnerável a dano de fogo. Reduzir os pontos de vida de uma seção de 3 metros da muralha a 0 destruirá essa seção, deixando para trás uma camada de ar gelado no espaço ocupado pela muralha. Uma criatura que atravesse a camada de ar gelado pela primeira vez num turno, deve realizar um teste deresistência de Constituição. Essa criatura sofrerá 5d6 de dano de frio se fracassar na resistência, ou metade desse dano se obtiver sucesso.",
  ...
  },
  {
    ...
    description: [
      "Reação  que você realiza quando você ou uma criatura a até 18 metros cair.",
  ...
  },
  {
    ...
    description: [
      "Você toca um humanoide morto ou um pedaço de um humanoide morto. Considerando que a criatura não esteja morta a mais de 10 dias, a magia forma um novo corpo adulto para ele e então, chama a alma para entrar no corpo. Se a alam do alvo não estiver livre ou deseje fazê-lo, a magia falha.",
