...
export const spells: SpellType[] = [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "incenso e uma oferenda apropriada para sacrifício à sua religião, juntos valendo, no mínimo, 25 po, consumidos pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma argola de jade valendo, no mínimo, 1.500 po, que você deve colocar na sua cabeça antes de conjurar a magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma gota de sangue, um pedaço de carne e uma punhado de pó de osso.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "ou um pedaço de alume embebido em vinagre para o efeito de antipatia, ou uma gota de mel para o efeito de simpatia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "um pergaminho de representação ou uma estatueta esculpida para se parecer com o alvo e um componente especial, que varia de acordo com a versão da magia que você escolher, valendo, no mínimo, 500 po por Dado de Vida.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "um baú requintado, de 90 cm por 60 cm por 60 cm, construído com materiais raros valendo, no mínimo, 5.000 po e uma réplica Miúda feita do mesmo material valendo, no mínimo, 50 po.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "um minúsculo relicário valendo, no mínimo, 1.000 po, contendo uma relíquia sagrada, como um pedaço de tecido do robe de um santo ou um pedaço de pergaminho de um texto religioso.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma tigela encrustada de gemas valendo, no mínimo, 1.000 po, que é consumida pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "giz e tintas raros infundidos com pedras preciosas no valor de 50 po, consumidos pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "água benta ou pó de prata e ferro valendo, no mínimo, 100 po, consumidos pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "um foco valendo, no mínimo, 100 po, também um chifre cravejado de joias para ouvir ou um olho de vidro para ver.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "incenso valendo, no mínimo, 250 po, consumido pela magia e quatro tiras de marfim valendo, no mínimo, 50 po cada.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "ervas, óleos e incenso valendo, no mínimo, 1.000 po, consumidos pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma estátua sua esculpida em marfim e decorada com gemas valendo, no mínimo, 1.500 po.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "um pouco de pelo; um pedaço de âmbar, vidro ou um bastão de cristal; e três pinos de prata.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "um pequeno pedaço de material do mesmo tipo do item que você planeja criar.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "um pote de barro cheio de terra de sepultura, um pote de barro cheio de água salobra, e uma ônix negra no valor de 150 po, para cada corpo.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma ágata valendo, no mínimo, 1.000 po que será consumida pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "um pouco de pó de diamante valendo 25 po polvilhado sobre o alvo, consumido pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "um conjunto de ferramentas de adivinhação – como ossos, bastões de marfim, dentes ou runas esculpidas – no valor de 100 po e um objeto do lugar que você deseja encontrar.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma peça hemisférica de cristal transparente e uma peça hemisférica que combine de goma arábica.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "espada de platina em miniatura com cabo e pomo de cobre e zinco valendo, no mínimo, 250 po.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "incenso e pó de diamante valendo, no mínimo, 200 po, consumidos pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma perola de vidro ou cristal que se despedaça quando a magia termina.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "um composto de pós de diamante, esmeralda, rubi e safira valendo, no mínimo, 5.000 po, consumidos pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "um portal em miniatura esculpido em marfim, um pedaço de mármore polido e uma pequena colher de prata, cada item valendo, no mínimo, 5 po.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma gota de mercúrio, uma porção de goma arábica e um pouco de fumaça.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma lâmina de ferro e uma pequena sacola contendo uma mistura de solos – argila, barro e areia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma vareta brilhante de incenso ou um frasco de cristal cheio de material fosforescente.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "alguns grãos de açúcar, alguns miolos de grão e uma mancha de gordura.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma borrifada de água benta, incensos raros e pó de rubi valendo, no mínimo,1.000 po.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "para cada criatura que você afetar com essa magia, você deve fornecer um jacinto valendo, no mínimo, 1.000 po e uma barra de prata com ornamentos esculpidos valendo, no mínimo, 100 po, todos consumidos pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma pequena réplica sua feita com materiais valendo, no mínimo, 5 po.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "incenso aceso, uma porção de enxofre e óleo, uma corda amarrada, uma porção de sangue de tribulo brutal e um pequeno bastão de prata valendo, no mínimo, 10 po.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "um galho de uma árvore que tenha sido atingida por um relâmpago.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma gema, cristal, relicário ou algum outro tipo de recipiente ornamental valendo, no mínimo, 500 po.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "óleos e unguentos raros valendo, no mínimo, 1.000 po, consumidos pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "um borrifo de água benta e diamantes valendo, no mínimo, 25.000 po, consumidos pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "pó de diamante valendo, no mínimo, 100 po, consumido pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma folha de chumbo, um pedaço de vidro opaco, um chumaço de algodão ou pano e pó de crisólita.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "mercúrio, fósforo e pó de diamante e opala, com um valor total de, no mínimo, 1.000 po, consumidos pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "neve ou gelo em quantidade suficiente para fazer uma cópia em tamanho real da criatura duplicada; algum cabelo, recortes de unha ou outro pedaço do corpo da criatura, colocado dentro da neve ou gelo; e pó de rubi no valor de 1.500 po, polvilhado sobre a duplicata e consumido pela magia.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "uma haste metálica bifurcada valendo, no mínimo, 250 po, sintonizada com um plano de existência em particular.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "um foco valendo, no mínimo, 1.000 po, como uma bola de cristal, espelho de prata ou fonte cheia de água benta.",
    description: [
  ...
  },
  {
    ...
    concentration: false,
    material:
      "unguento para os olhos no valor de 25 po; ele é feito de pó de cogumelo, açafrão e gordura; e é consumido pela magia.",
    description: [
